...
namespace Lerawin.Classes
{
    ...
    public class Netvars
    {
        ...
        public int m_hTonemapController = 0x31DC;
        public int m_iWorldModelIndex = 0x3254;
        public int m_iItemIDLow = 0x2FD4;
        public int m_nModelIndex = 0x258;
        public int m_iViewModelIndex = 0x3250;
        public int m_iWorldDroppedModelIndex = 0x3258;
        public int m_iWeaponID = 0x34;
        public int m_bSilencerOn = 0x3361;
        public int m_bInBuyZone = 0x99B5;
        public int m_iPlayerC4 = 0x165C;
        public int m_bReloadVisuallyComplete = 0x3360;
        public int m_totalHitsOnServer = 0x103F8;
        public int m_bIsWalking = 0x9975;
        public int m_iKills = 0xC2C;
        public int m_iScore = 0x1980;
        public int m_iPing = 0xB28;
        public int m_iTeam = 0xF38;
        public int m_flFOVRate = 0x3010;
    }
    ...
    public class RootObject
    {
        ...
        //public hcNetvars hcNetvars { get; set; }
    }
}
